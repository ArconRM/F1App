...
final class RoundDetailsPresenter: Presenter {
    typealias View = RoundDetailsPresentable
    ...
    private func loadRoundResults() {
        roundResultsNetworkService.fetchRoundResults(year: round.year, roundNumber: round.roundNumber, resultQueue: .main) { [weak self] result in
            switch result {
