...
final class DriverDetailsViewController: BaseViewController {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            driverDetailsCardView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            driverDetailsCardView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16)
        ])
    }
