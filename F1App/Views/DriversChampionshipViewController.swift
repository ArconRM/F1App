...
class DriversChampionshipViewController: BaseViewController {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            championshipTableView.bottomAnchor.constraint(equalTo: scrollContainerView.bottomAnchor)
        ])
    }
    ...
    // MARK: - Data Methods
    public func loadedDriversChampionship(_ driversChampionship: [DriversChampionshipEntry?]) {
